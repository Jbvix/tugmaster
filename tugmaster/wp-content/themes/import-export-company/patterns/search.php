 ...
 * Search Section
 * 
 * slug: import-export-company/search-page
 * title: Search Page
 * categories: import-export-company
 */

return array(
    'title'      =>__( 'Search Page', 'import-export-company' ),
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"import-export-company","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
);
